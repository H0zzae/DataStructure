	...
	*/
	...
	SparseMatrix Add(SparseMatrix b) {
		...
		while((aPos < terms)&&(bPos < b.terms)){
			if(smArray[aPos].row-b.smArray[bPos].row>0){
				c.NewTerm(b.smArray[bPos].row,b.smArray[bPos].col,b.smArray[bPos].value);
				bPos++;
			}
			else if((smArray[aPos].row-b.smArray[bPos].row==0)&&(smArray[aPos].col==b.smArray[bPos].col)){
				if(b.smArray[bPos].value+smArray[aPos].value!=0){
				c.NewTerm(b.smArray[bPos].row,b.smArray[bPos].col,b.smArray[bPos].value+smArray[aPos].value);
				}bPos++;
				aPos++;
			}else if((smArray[aPos].row-b.smArray[bPos].row==0)&&(smArray[aPos].col!=b.smArray[bPos].col)){
